...
RUN curl -s -L https://julialang.s3.amazonaws.com/bin/linux/x64/0.4/julia-0.4.5-linux-x86_64.tar.gz

RUN tar -zxvf julia-0.4.5-linux-x86_64.tar.gz -C /opt/julia_0.4.5
